...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30964 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30964(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30965 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30965(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30966 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30966(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30970 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30970(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30974 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30974(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30985 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30985(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30938,callback){
var map__30945 = p__30938;
var map__30945__$1 = cljs.core.__destructure_map(map__30945);
var input = map__30945__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30945__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30945__$1,new cljs.core.Keyword(null,"ns","ns",441598760));

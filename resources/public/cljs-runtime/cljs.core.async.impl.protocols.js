...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28159 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28159(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28163 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28163(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28166 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28166(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28168 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28168(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28172 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28172(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28173 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28173(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28174 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28174(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28180 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28180(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28183 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28183(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28184 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28184(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28185 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28185(b);
}
});

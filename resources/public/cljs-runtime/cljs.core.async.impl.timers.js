...
var i_31020 = (0);
while(true){
if((i_31020 < arr.length)){
(arr[i_31020] = null);

var G__31021 = (i_31020 + (1));
i_31020 = G__31021;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_31049 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31049[i]));
} else {
x__$2.forward.push((((i < links_31049.length))?(links_31049[i]):null));
}

if((i < links_31049.length)){
(links_31049[i] = x__$2);
} else {
links_31049.push(x__$2);
}
...
var links_31066 = (update[i_31063]).forward;
if((x__$1 === (((i_31063 < links_31066.length))?(links_31066[i_31063]):null))){
(links_31066[i_31063] = (x__$1.forward[i_31063]));

var G__31070 = (i_31063 + (1));
i_31063 = G__31070;
continue;
} else {
var G__31071 = (i_31063 + (1));
i_31063 = G__31071;
continue;
}
} else {
